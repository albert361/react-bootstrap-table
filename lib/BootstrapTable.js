  ...
  _createClass(BootstrapTable, {
    ...
    componentDidMount: {
      value: function componentDidMount() {
        if (this.refs.toolbar) this.refs.toolbar.componentMounted();
      }
    },
    componentDidUpdate: {
    ...
    handleEditRow: {
      value: function handleEditRow(newObj) {
        try {
    ...
    handlePrepareEdit: {
      value: function handlePrepareEdit(callback) {
        var editRowKeys = this.store.getSelectedRowKeys();
        if (editRowKeys.length != 1) {
          // throw 'Currenty only support one row edit.';
          return undefined;
        }
        var item = this.store.getByKey(editRowKeys[0]);
        return item;
      }
    },
    doDropRow: {
      value: function doDropRow() {
    ...
    handleNewBtnClicked: {
      value: function handleNewBtnClicked() {
        if (this.props.selectRow.onSelect) {
      ...
      value: function renderToolBar() {
        ...
        if (this.props.insertRow || this.props.deleteRow || this.props.search || this.props.editRow) {
          return React.createElement(
            "div",
            { className: "tool-bar" },
            React.createElement(ToolBar, { ref: "toolbar", enableInsert: this.props.insertRow,
