    ...
    render: {
      value: function render() {
        ...
        var editBtn = this.props.enableEdit ? React.createElement(
          "button",
          { type: "button", className: "btn btn-warning", "data-toggle": "modal", "data-target": "." + modalClassName, onClick: this.handleEditBtnClick.bind(this) },
          "Edit"
        ) : null;

        var deleteBtn = this.props.enableDelete ? React.createElement(
          "button",
          { type: "button", className: "btn btn-danger", "data-toggle": "tooltip", "data-placement": "right", title: "Delete selected items",
        ...
        var inputField = this.props.columns.map((function (column, i) {
          ...
          if (!addOptions.hidden) {
            switch (addOptions.type) {
              case "text":
                return React.createElement(
                  ...
                  React.createElement("input", { ref: column.field + i, type: "text", className: "form-control", placeholder: column.name, value: this.state.item[column.field] })
                );
                break;
              case "select":
                return React.createElement(
            ...
            return React.createElement(
              "div",
              { className: "form-group", key: column.field },
              React.createElement("input", { ref: column.field + i, type: "hidden", className: "form-control", placeholder: column.name })
            );
          }
        }).bind(this));
