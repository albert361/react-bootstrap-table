    ...
    render: {
      value: function render() {
        ...
        var insertBtn = this.props.enableInsert ? React.createElement(
          "button",
          { type: "button", className: "btn btn-default", "data-toggle": "modal", "data-target": "." + modalClassName, onClick: this.handleNewBtnClick.bind(this) },
          "New"
        ) : null;
            ...
            switch (addOptions.type) {
              ...
              case "checkbox":
                return React.createElement(
                  ...
                  React.createElement("input", { ref: column.field + i, type: "checkbox", className: "form-control" })
                );
                break;
            }
          } else {
